...
//     var stormGlassEndpoint = `https://api.stormglass.io/v2/weather/point?lat=${58.7984}&lng=${17.8081}&params=${params}`
//     // console.log(stormGlassEndpoint)

//     fetch(stormGlassEndpoint, {
//         headers: {
...
function handleSearchButton(event) {
    ...
    let surfSpot = document.getElementById("searched-city-input").value;

    if (surfSpot) {
        getSurfReport(surfSpot)//passes cityName to getWeatherByCity
        // cityName.value = "";
    } else {
        prompt("City search field required");
    }
...
// 37.755453248154005, -122.52929195993495
// const lat = 58.7984;
// const lng = 17.8081;

function getSurfReport(surfSpot) {
    if(surfSpot === "Ocean Beach") {
        ...
        fetch(`https://api.stormglass.io/v2/weather/point?lat=${lat}&lng=${lng}&params=${params}&source=${source}&end${currentHour}`, {
  headers: {
    'Authorization': "5c5365e4-a940-11ed-a138-0242ac130002-5c53665c-a940-11ed-a138-0242ac130002"
  }
